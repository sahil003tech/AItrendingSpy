...
const Section1Community = () => {
    return (
        <div style={{ backgroundColor: '#E3E2F8' }}>
            <div className='col-sm-9 col-11 row mx-auto'>
                <div className='mb-5 ' style={{  paddingTop: '100px' }} >
                    <div className='row d-flex justify-content-center'>
                        <div className='col-xxl-6 ' style={{ marginRight: '0px' }}>
                        ...
                        <div className='col-xxl-6 col-sm-11 col-11 ' style={{ marginRight: '0px' }}>
