...
const Section1Stratergy = () => {
  return (
    ...
    <div style={{height:'600px', width:'100vw', padding:'100px'}} >
        ...
        <h1 style={{color:'black',  borderLeft:'2px solid blue' }} className='text-uppercase fw-bolder my-3 px-2 col-9 '>Strategist Studio automate your trading strategies</h1>
        <p className='my-3' style={{ color:'black'}}>Designed with the expert trader in mind, Strategist Studio enables you to automate your well-honed trading strategies using our sophisticated tools and skilled team of developers.</p>
        </div>
        <div className='col-5 d-flex justify-content-end' style={{width:'50vw', marginRight:'0px'}}>
        <img style={{width:'30vw'}} src="https://cdn.builder.io/api/v1/image/assets%2Fccc0df0d3e6f4b5e827d356845fdfc11%2Fb2c9116bc0f146b287419a7c4055c17e" alt="circle"/>
        </div>
        </div>
...
<div className='row ' style={{ padding:'100px'}}>
    <h3 style={{ color:'black', borderLeft:'2px solid blue' }}>Trading Strategy Made Simple</h3>
        <p style={{ color:'black' }} className='col-8 my-3'>Strategist Studio is an intuitive interface where you can precisely define your trading strategy. Our cutting-edge system translates these parameters into an automated algorithm, creating a customized AI model that mirrors your trading style, be it focused on day-trading, swing-trading, or long-term investing.</p>
        </div>
          <div className='row ' style={{ paddingLeft:'100px', paddingRight:'100px'}}>
            <div  className='col-6'>
            <h3 style={{color:'blue'}}>Expert Support To Help Build Your Trading Strategies</h3>
            ...
            <ul >
                <li style={{color:'black'}}><AiFillCheckCircle className='mt-3' style={{ color: '#D3C5F3' }} />Turn knowledge and experience into trading strategy</li>
                <li style={{color:'black'}}><AiFillCheckCircle className='mt-3' style={{ color: '#D3C5F3' }} />Get support from AITradingSpy team to develop it</li>
                <li style={{color:'black'}}><AiFillCheckCircle className='mt-3' style={{ color: '#D3C5F3' }} />Support from experienced traders and developers</li>
                <li style={{color:'black'}}><AiFillCheckCircle className='mt-3' style={{ color: '#D3C5F3' }} />Monetize your knowledge</li>
            </ul>
            </div>
            <div className='col-6'>
            <h3 style={{color:'blue'}}>Generate Income From Your Trading Strategies</h3>
...
<div className='d-flex justify-content-center row mx-5' style={{ padding:'100px'}}>
        <h3 style={{ color:'blue'}} className='text-center col-12'>Get started with Strategist Studio now</h3>
